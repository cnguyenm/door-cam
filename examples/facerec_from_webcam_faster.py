...
# Load a second sample picture and learn how to recognize it.
joe_image = face_recognition.load_image_file("img/joe.jpg")
joe_face_encoding = face_recognition.face_encodings(joe_image)[0]

# Load a second sample picture and learn how to recognize it.
duc_image = face_recognition.load_image_file("img/duc.jpg")
duc_face_encoding = face_recognition.face_encodings(duc_image)[0]
